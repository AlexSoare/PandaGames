...
public class EsLevel4 implements KeyListener , ActionListener{
	
	JFrame f = new JFrame("Level 4");
	
	JFrame f2 = new JFrame("Restart");

	
	int i,j,x,q,textur,a,b,but,pozc,q2,c=0; // la nevoie
	int dor,dor2=0; // usa
	int ob=1,ob1,ob2,ob3,ob4,ob5,ob6; //,on(n) , AICI ADAUGI ob(n) , target-uri noi 
	...
	JLabel obs4 = new JLabel();
	JLabel obs5 = new JLabel();
	JLabel obs6 = new JLabel();
	...
	public EsLevel4() throws Exception{
		...
		time.schedule(new Time(), 10);
		
		
		f.setSize(725,748); //720 720
		f.setLayout(null);
		...
		win.setBounds(0,0,720,720);
		win.setIcon(new ImageIcon("Resource/Escape/Img/Congrat.png"));
		...
		p4=120;
		pozo4 = 31;
		obs4.setBounds(o4,p4,60,60);
		obs4.setIcon(obs);
		
		o5=300;
		p5=120;
		pozo5 = 29;
		obs5.setBounds(o5,p5,60,60);
		obs5.setIcon(obs);
		
		o6=180;
		p6=120;
		pozo6 = 27;
		obs6.setBounds(o6,p6,60,60);
		obs6.setIcon(obs);
		...
		File file = new File("Resource/Escape/lvl/l4.txt");
		s = new Scanner(file);
	...
	public void VerificareCastig(){
		...
		if((pozo1==ob1 || pozo2==ob1 || pozo3==ob1  || pozo4==ob1 || pozo5==ob1 || pozo6==ob1)&&(pozo1==ob2 || pozo2==ob2 || pozo3==ob2 || pozo4==ob2 || pozo5==ob2 || pozo6==ob2)&&(pozo1==ob3 || pozo2==ob3 || pozo3==ob3 || pozo4==ob3 || pozo5==ob3 || pozo6==ob3)&&(pozo1==ob4 || pozo2==ob4 || pozo3==ob4  || pozo4==ob4 || pozo5==ob4 || pozo6==ob4)&&(pozo1==ob5 || pozo2==ob5 || pozo3==ob5  || pozo4==ob5 || pozo5==ob5 || pozo6==ob5)&&(pozo1==ob6 || pozo2==ob6 || pozo3==ob6  || pozo4==ob6 || pozo5==ob6 || pozo6==ob6))
		{
			try {
	    	...
	    	d.start();
			v.get(dor).setIcon(new ImageIcon("Resource/Escape/Img/door4.gif"));
			dor2=1;
		}
	...
	public void keyPressed(KeyEvent e) {
		...
		if(but==38 && mapa.get(pozc-12)!=1 && pozc-12!=dor) // Sus
		{
				...
				for(i=pozc-12;i>=pozc-24;i=i-12)
				{
					...
					if(poz.get(i)==1 || poz.get(i)==2 || poz.get(i)==3 || poz.get(i)==4 || poz.get(i)==5 || poz.get(i)==6) 
					{
						q++;
						q2++;
					}
