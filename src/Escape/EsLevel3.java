...
public class EsLevel3 implements KeyListener , ActionListener{
	
	JFrame f = new JFrame("Level 3");
	...
	int dor,dor2=0; // usa
	int ob=1,ob1,ob2,ob3,ob4; //,on(n) , AICI ADAUGI ob(n) , target-uri noi 
	...
	public EsLevel3() throws Exception{
		...
		//////////////////////////////////// AICI BAGI FISIERUL MATRICIEI l(level);
		File file = new File("Resource/Escape/lvl/l3.txt");
		s = new Scanner(file);
	...
	public void VerificareCastig(){
		...
		if((pozo1==ob1 || pozo2==ob1 || pozo3==ob1 || pozo4==ob1)&&(pozo1==ob2 || pozo2==ob2 || pozo3==ob2 || pozo4==ob2)&&(pozo1==ob3 || pozo2==ob3 || pozo3==ob3 || pozo4==ob3)&&(pozo1==ob4 || pozo2==ob4 || pozo3==ob4 || pozo4==ob4))
		{
			try {
	    	...
	    	d.start();
			v.get(dor).setIcon(new ImageIcon("Resource/Escape/Img/door3.gif"));
			dor2=1;
		}
	...
	public void keyPressed(KeyEvent e) {
		...
		if(but==38 && mapa.get(pozc-12)!=1 && pozc-12!=dor) // Sus
		{
				...
				for(i=pozc-12;i>=pozc-24;i=i-12)
				{
					...
					if(poz.get(i)==1 || poz.get(i)==2 || poz.get(i)==3 || poz.get(i)==4) 
					{
						q++;
						q2++;
					}
