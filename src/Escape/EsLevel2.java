...
public class EsLevel2 implements KeyListener , ActionListener{
	
	JFrame f = new JFrame("Level 2");
	...
	public EsLevel2() throws Exception{
		...
		File file = new File("Resource/Escape/lvl/l2.txt");
		s = new Scanner(file);
	...
	public void VerificareCastig(){
		if((pozo1==ob1 || pozo2==ob1 || pozo3==ob1 || pozo4==ob1)&&(pozo1==ob2 || pozo2==ob2 || pozo3==ob2 || pozo4==ob2)&&(pozo1==ob3 || pozo2==ob3 || pozo3==ob3 || pozo4==ob3)&&(pozo1==ob4 || pozo2==ob4 || pozo3==ob4 || pozo4==ob4))
		{
	    	...
	    	d.start();
			v.get(dor).setIcon(new ImageIcon("Resource/Escape/Img/door2.gif"));
			dor2=1;
		}
